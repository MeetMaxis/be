...
const StockAvailabillity = ({ stock, inStock } : { stock: number, inStock: number }) => {
  return (
    ...
    { inStock === 1 ? <span className='text-success flex items-center gap-x-1'>В наличии <FaCheck /></span> :  <span className='text-error flex items-center gap-x-1'>Нет в наличии <FaXmark /></span>}
