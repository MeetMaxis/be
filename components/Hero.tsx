...
const Hero = () => {
  return (
    <div className="h-[700px] w-full bg-zinc-900 max-lg:h-[900px] max-md:h-[750px]">
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-10 max-lg:order-last col-span-2">
          <h1 className="text-6xl text-white font-bold mb-3 max-xl:text-5xl max-md:text-4xl max-sm:text-3xl">
            Apple Watch
          </h1>
          <p className="text-white max-sm:text-sm max-w-3xl">
          ...
          <div className="flex gap-x-2 max-lg:flex-col max-lg:gap-y-1">
            <button className="bg-white text-zinc-900 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              Купить
            </button>
            <button className="bg-white text-zinc-900 font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              Узнать больше
